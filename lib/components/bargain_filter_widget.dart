...
import 'bargain_filter_model.dart';
...
class _BargainFilterWidgetState extends State<BargainFilterWidget>
  ...
  late BargainFilterModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BargainFilterModel());
                                  ...
                                  child: ExpandablePanel(
                                    ...
                                    expanded: Column(
                                      ...
                                      children: [
                                        ...
                                        if ((FFAppState().BargainUserFilter ==
                                                false) &&
                                            (FFAppState().userFilter == null ||
                                                FFAppState().userFilter == ''))
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                  ...
                                  child: ExpandablePanel(
                                    ...
                                    expanded: Column(
                                      ...
                                      mainAxisAlignment:
                                          MainAxisAlignment.start,
                                      children: [
                                        if (FFAppState().PostFilter != null &&
                                            FFAppState().PostFilter != '')
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 20.0, 0.0, 0.0),
                                        ...
                                        if ((FFAppState().PostFilterBool ==
                                                false) &&
                                            (FFAppState().PostFilter == null ||
                                                FFAppState().PostFilter == ''))
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                        ...
                                        if (FFAppState().PostFilterBool == true)
                                          Row(
                                            mainAxisSize: MainAxisSize.max,
                                            children: [
                                              Expanded(
