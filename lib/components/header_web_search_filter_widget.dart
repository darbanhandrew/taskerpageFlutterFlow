...
import 'header_web_search_filter_model.dart';
...
class _HeaderWebSearchFilterWidgetState
    extends State<HeaderWebSearchFilterWidget> {
  late HeaderWebSearchFilterModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HeaderWebSearchFilterModel());
