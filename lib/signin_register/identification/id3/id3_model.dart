...
import 'id3_widget.dart' show Id3Widget;
...
class Id3Model extends FlutterFlowModel<Id3Widget> {
  ...
  // Stores action output result for [Backend Call - API (Get Identification Details)] action in ID3 widget.
