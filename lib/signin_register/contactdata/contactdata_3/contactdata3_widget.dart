              ...
              Flexible(
                child: Column(
                  ...
                  children: [
                    ...
                    Stack(
                      children: [
                        if (FFAppState().NotificationForAnewPassOrEmail == true)
                          Padding(
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        InkWell(
                                          ...
                                          highlightColor: Colors.transparent,
                                          onTap: () async {
                                            context.pushNamed('Contactdata-7');
                                          },
                                          child: ClipRRect(
                                            borderRadius:
                                                BorderRadius.circular(0.0),
                                                    ...
                                                    padding:
                                                        EdgeInsetsDirectional
                                                            .fromSTEB(10.0, 0.0,
                                                                0.0, 0.0),
                                                    child: Text(
                                                      'Konrad-Adenauer-Allee 1144263 Dortmund, Germany',
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        InkWell(
                                          ...
                                          highlightColor: Colors.transparent,
                                          onTap: () async {
                                            context.pushNamed('Contactdata-2');
                                          },
                                          child: ClipRRect(
                                            borderRadius:
                                                BorderRadius.circular(0.0),
