...
import 'forget_password2_model.dart';
...
class _ForgetPassword2WidgetState extends State<ForgetPassword2Widget> {
  late ForgetPassword2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ForgetPassword2Model());
              ...
              Flexible(
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(32.0, 65.0, 32.0, 0.0),
                      child: Row(
                        mainAxisSize: MainAxisSize.max,
                        children: [
                          Padding(
