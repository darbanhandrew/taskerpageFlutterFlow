...
import 'sign_up_verification_request_widget.dart'
...
class SignUpVerificationRequestModel
    extends FlutterFlowModel<SignUpVerificationRequestWidget> {
  ///  State fields for stateful widgets in this page.

  final unfocusNode = FocusNode();
  // Stores action output result for [Backend Call - API (userProfileRead)] action in Sign-up-Verification-Request widget.
  ApiCallResponse? sendCode;
  // Stores action output result for [Backend Call - API (send to verification code)] action in Sign-up-Verification-Request widget.
