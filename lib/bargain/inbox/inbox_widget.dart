                                    ...
                                    child: Padding(
                                      ...
                                      child: FutureBuilder<ApiCallResponse>(
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          final listViewBidListResponse =
                                              snapshot.data!;
                                          return Builder(
                                            builder: (context) {
                                              final myBargains = getJsonField(
                                                listViewBidListResponse
                                                    .jsonBody,
                                                r'''$.data''',
                                              ).toList();
                                              return ListView.separated(
                                                ...
                                                itemCount: myBargains.length,
                                                separatorBuilder: (_, __) =>
                                                    SizedBox(height: 16.0),
                                                itemBuilder:
                                                    (context, myBargainsIndex) {
                                                  final myBargainsItem =
                                                      myBargains[
                                                          myBargainsIndex];
                                                  return Padding(
                                                    padding:
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: FutureBuilder<ApiCallResponse>(
                                      future:
                                          TaskerpageBackendGroup.myBidCall.call(
                                        apiGlobalKey: FFAppState().apiKey,
                                        fields:
                                            '[\"name\",\"price\",\"price_type\",\"post\",\"creation\",\"poster\"]',
                                        filters:
                                            '[[\"bider\",\"=\",\"${getJsonField(
                                          FFAppState().userProfile,
                                          r'''$.data.name''',
