                  ...
                  children: [
                    if (responsiveVisibility(
                      ...
                      Column(
                        ...
                        children: [
                          wrapWithModel(
                            model: _model.sideBarLeftAppointmentModel,
                            updateCallback: () => setState(() {}),
                            child: SideBarLeftAppointmentWidget(),
                          ),
                        ],
                      ),
                    Expanded(
                                            ...
                                            child: Padding(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  ...
                                                  if (_model.selectDate == null)
                                                    ClipRRect(
                                                      borderRadius:
                                                          BorderRadius.circular(
                                                              0.0),
                                                      child: Image.asset(
                                                        'assets/images/Mask_Group_336.png',
                                                        width: 25.0,
                                                        height: 25.0,
                                                        fit: BoxFit.none,
                                                      ),
                                                                    ...
                                                                    itemBuilder:
                                                                      ...
                                                                      return Visibility(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          key: Key(
                                                                              'Keyi0p_${invationAppointmentIndex}_of_${invationAppointment.length}'),
                                                                          json:
                                                                              invationAppointmentItem,
                                                                          accepted:
                                                                              true,
                                                                    ...
                                                                    return ListView
                                                                      ...
                                                                      itemBuilder:
                                                                        ...
                                                                        final pendingAppointmentItem =
                                                                            pendingAppointment[pendingAppointmentIndex];
                                                                        return Visibility(
                                                                          visible: _model.selectDate != null
                                                                              ? (functions.jsonToDateTime(getJsonField(
                                                                          ...
                                                                          child:
                                                                              AppointmentCardWidget(
                                                                            key:
                                                                                Key('Keynz0_${pendingAppointmentIndex}_of_${pendingAppointment.length}'),
                                                                            json:
                                                                                pendingAppointmentItem,
                                                                            accepted:
                                                                                false,
                                                                    ...
                                                                    itemBuilder:
                                                                      ...
                                                                      return Visibility(
                                                                        ...
                                                                        child:
                                                                            AppointmentCardWidget(
                                                                          key: Key(
                                                                              'Key5e5_${acceptedAppointmentIndex}_of_${acceptedAppointment.length}'),
                                                                          json:
                                                                              acceptedAppointmentItem,
                                                                          accepted:
                                                                              false,
                                                                    ...
                                                                    itemBuilder:
                                                                      ...
                                                                      return Visibility(
                                                                        ...
                                                                        child:
                                                                            AppointmentCardWidget(
                                                                          key: Key(
                                                                              'Keynmm_${rejectedAppointmentIndex}_of_${rejectedAppointment.length}'),
                                                                          json:
                                                                              rejectedAppointmentItem,
                                                                          accepted:
                                                                              false,
                                                                    ...
                                                                    itemBuilder:
                                                                      ...
                                                                      return Visibility(
                                                                        ...
                                                                        child:
                                                                            AppointmentCardWidget(
                                                                          key: Key(
                                                                              'Key610_${acceptedAppointmentIndex}_of_${acceptedAppointment.length}'),
                                                                          accepted:
                                                                              false,
                                                                          state:
                                                                              'done',
                                                                          ...
                                                                          view:
                                                                              () async {
                                                                            _model.review =
                                                                                await TaskerpageBackendGroup.reviewReadByIdCall.call(
                                                                              apiGlobalKey: FFAppState().apiKey,
                                                                              filters: '[[\"appointment\",\"=\",\"${getJsonField(
                                                                                acceptedAppointmentItem,
                                                                                r'''$.name''',
                                                                              ...
                                                                              fields: '[\"appointment\",\"name\",\"reviewed_by\",\"review_rate\",\"comment\"]',
                                                                            );
                                                                            if (functions.checkLenghtlist(getJsonField(
