...
class TaskerFilterWidget extends StatefulWidget {
  ...
  @override
  State<TaskerFilterWidget> createState() => _TaskerFilterWidgetState();
}
                                                                  ...
                                                                  builder: (context,
                                                                    ...
                                                                    return FlutterFlowDropDown<
                                                                      ...
                                                                      onChanged:
                                                                        ...
                                                                        var _shouldSetState =
                                                                            false;
                                                                        _model.addressDetails = await TaskerpageBackendGroup
                                                                        ...
                                                                        _shouldSetState =
                                                                            true;
                                                                        if ((_model.addressDetails?.succeeded ??
                                                                            true)) {
                                                                          setState(
                                                                              () {
                                                          ...
                                                          child: FutureBuilder<
                                                            ...
                                                            builder: (context,
                                                              ...
                                                              return Builder(
                                                                builder:
                                                                    (context) {
                                                                  final serviceCategoryList = TaskerpageBackendGroup
                                                                          .serviceCategoryListCall
                                                                          .serviceCategoryList(
                                                                        ...
                                                                        InkWell(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            decoration:
                                                                              ...
                                                                              border: Border.all(
                                                                                color: skillLevelsListItem == FFAppState().taskFilter.skillFilter.skillLevel ? FlutterFlowTheme.of(context).primary : FlutterFlowTheme.of(context).secondary,
                                                                              ),
                                                                            ),
                                                                            child:
                                                                                Padding(
                                                                  ...
                                                                  FFAppState()
                                                                    ...
                                                                    (e) => e
                                                                      ..updateTaskerTypeFilter(
                                                                        (e) => e
                                                                          ..gender = _model.radioButtonValue1 == 'any'
                                                                              ? ''
                                                                ...
                                                                setState(() {
                                                                  FFAppState()
                                                                    ...
                                                                    (e) => e
                                                                      ..updateTaskerTypeFilter(
                                                                        (e) => e
                                                                          ..ageRange = _model.radioButtonValue2 == 'Dosn\'t matter'
                                                                              ? ''
                      ...
                      children: [
                        InkWell(
                          ...
                          onTap: () async {
                            _model.updatePage(() {
                              FFAppState().updateTaskerFilterStruct(
                                (e) => e
                                  ..updateTaskerTypeFilter(
                                    (e) => e
                                      ..hasInsurance = _model.switchValue4
                                      ..hasIdentification = _model.switchValue5
                                      ..languages = _model.dropDownValue2,
                                  )
                                  ..updateLocationFilter(
                                    (e) => e..radius = _model.sliderValue,
                                  ),
                              );
                            });
                            ...
                            _model.customerProfileNameCopy =
                                await TaskerpageBackendGroup
                                    .customerProfileSkillsListCall
                                    .call(
                              filters:
                                  functions.convertDataTypeToTaskerSkillFilter(
                                      FFAppState().taskerFilter.skillFilter),
                              fields: '[\"customer_profile\"]',
                              apiGlobalKey: FFAppState().apiKey,
                            );
                            if ((_model.customerProfileNameCopy?.succeeded ??
                                true)) {
                              _model.updatePage(() {
                                FFAppState().updateTaskerFilterStruct(
                                  (e) => e
                            ...
                            Navigator.pop(context, FFAppState().taskerFilter);
