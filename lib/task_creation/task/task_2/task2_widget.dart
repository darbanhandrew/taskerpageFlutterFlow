                                                                    ...
                                                                    children: [
                                                                      Text(
                                                                        ...
                                                                        style: FlutterFlowTheme.of(context)
                                                                            ...
                                                                            .override(
                                                                              fontFamily: 'Lato',
                                                                              color: FFAppState().createTask.taskDeatels.skillName ==
                                                                                      getJsonField(
                                                                                        servicesItem,
                                                                                        r'''$.name''',
                                                                                      )
                                                          ...
                                                          Text(
                                                            ...
                                                            style: FlutterFlowTheme
                                                                ...
                                                                .override(
                                                                  fontFamily:
                                                                      'Lato',
                                                                  color: FFAppState().createTask.taskDeatels.skillLevel ==
                                                                          skillLevelItem
                                                                      ? FlutterFlowTheme.of(
                                                                              context)
                                                                          .primary
                                                                    ...
                                                                    Expanded(
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          key:
                                                                              Key(
                                                                            'Keynis_${getJsonField(
                                                                              skillOptionsItem,
                                                                              r'''$.option_name''',
                                                                            ).toString()}',
                                                                          ),
                                                                          skillOption:
                                                                              SkillOptionsStruct.maybeFromMap(getJsonField(
                                                                            skillOptionsItem,
                                                                            r'''$''',
                                                                          ))!,
                                                                          defaultValue: FFAppState().createTask.taskOptions[skillOptionsIndex].values == 'true'
                                                                              ? true
                                                                              : false,
                                                                        ),
                                                                      ),
                                          ...
                                          children: [
                                            ...
                                            InkWell(
                                              ...
                                              onTap: () async {
                                                ...
                                                while (_model.skillOptionList
                                                        .length >
                                                    0) {
                                                  if (_model.skillOptionList
                                                          .first.type ==
                                                      'Check') {
                                                    _model
                                                        .addToTempSkillOptionList(
                                                            SkillOptionsStruct(
                                                      name: _model
                                                          .skillOptionList
                                                          .first
