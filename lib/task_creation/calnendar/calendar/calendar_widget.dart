                                                          ...
                                                          Text(
                                                            ...
                                                            style: FlutterFlowTheme
                                                                ...
                                                                .override(
                                                                  fontFamily:
                                                                      'Lato',
                                                                  color: FFAppState().createTask.taskSchedule.startRangeTime ==
                                                                          'Morning (7:00-12:00)'
                                                                      ? FlutterFlowTheme.of(
                                                                              context)
                                                                          .primary
                                                                    ...
                                                                    children: [
                                                                      Text(
                                                                        ...
                                                                        style: FlutterFlowTheme.of(context)
                                                                            ...
                                                                            .override(
                                                                              fontFamily: 'Lato',
                                                                              color: FFAppState().createTask.taskSchedule.repeatableTaskDetails.preferredDays.contains(getJsonField(
                                                                                        daysItem,
                                                                                        r'''$.shortName''',
                                                                                      ).toString())
                                              ...
                                              InkWell(
                                                ...
                                                onTap: () async {
                                                  ...
                                                  _model.updatedSchedule2 =
                                                    ...
                                                    apiGlobalKey:
                                                        FFAppState().apiKey,
                                                    daysPerWeek: FFAppState()
                                                        .createTask
                                                        .daysPerWeek,
                                                  );
                                                  _shouldSetState = true;
                                                  if ((_model.updatedSchedule2
                                                          ?.succeeded ??
                                                      true)) {
                                                    context.pushNamed(
                                                      'Rates',
